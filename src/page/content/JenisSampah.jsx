        ...
        return (
                <div className="relative h-[500px] ">
                        <div className="mt-16  flex justify-center items-center ">
                                <h1 className="text-[45px] font-bold text-[#121F0B]">Edukasi Pemilahan Sampah
                                </h1>
                                <img
                        ...
                        <div className="mb-16 flex justify-center items-center ">
                                <h3 className="text-2xl font-normal text-[#121F0B]">Ayo, kenali jenis sampahmu dengan klik kartu pintar t-Recx di bawah ini !
                                </h3>
                        </div>
                        ...
                        {selectedType && (
                                <DetailJenisSampah type={selectedType} />
                        )}
                </div>
        );
}