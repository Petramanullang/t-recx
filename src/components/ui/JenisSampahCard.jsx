...
const JenisSampahCard = ({ title, description, largeVisualSrc, detailImageSrc, type, onSelectType }) => {
            ...
            {isHovered && (
                <div className="w-full h-full bg-[#DEEBDE] flex flex-col items-center text-center p-4 transition-colors duration-300">
                    ...
                    <button 
                        ...
                        className="mt-auto px-6 py-2 bg-[#4E9574] text-white font-semibold rounded-full 
